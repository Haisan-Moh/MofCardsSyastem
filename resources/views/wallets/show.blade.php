                ...
                <form method="POST" action="/receipts">
                    ...
                    <div class="flex flex-col md:flex-row-reverse dir-right text-right text-sm text-gray-900 border-b-2 border-gray-200 py-1 mb-4">
                        ...
                        <div class="flex-auto">
                            ...
                            <input name="wallet_id" class="border-0 py-0" type="text" value="{{ $wallet->wallet_id }}" readonly>
                        </div>
                    </div>
                                ...
                                <table id="example" class="table table-striped table-bordered dir-right text-right text-xs" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" class="delete btn btn-danger btn-sm py-0">حذف</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="6" class="bg-gray-300">الاجمالي</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
